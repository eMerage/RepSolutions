package emerge.projects.repsolutions.ui.doctors.doctorupdate.adaptor
...
class DoctorUpdateAdaptor (val items: ArrayList<DoctorList>, val context: Context) :
    RecyclerView.Adapter<DoctorUpdateAdaptor.ViewHolderLocationList>() {
